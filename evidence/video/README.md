...
The MP4 and original capture clips are intended for the
...
**Export:** 150.000 seconds, 1280×720, H.264, no audio streams, 2,138,471 bytes.
SHA-256: `df5c25bcc7f0dd8866ac601124b69c24bd15f07cd791edb27492421cdbe7c083`.
...
| 1:50–2:10 | Actual ENS permission-check button | [UI state](ens-ui-state.json); Sepolia block 11696542; `ainize.node` allowed, `ainize.patch` refused; no transactions sent |
...
timing lists and manifests. Assembly uses 80/30/20/20 seconds at normal speed with small bottom captions.
